                ...
                switch (axis.orient()) {
                    ...
                    case 'right':
                        ...
                        axisLabel
                            ...
                            .attr('y', rotateYLabel ? (-Math.max(margin.right,width) + 28) : -10) //TODO: consider calculating this based on largest tick width... OR at least expose this on chart
    ...
    nv.models.cumulativeLineChart = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
				...
				availableHeight = adjustHeightOfChartDiv(availableHeight, height, margin, container);
